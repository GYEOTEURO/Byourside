...
class DBGet {
  ...
  // 작성한 글 보기
  static Stream<List<PostListModel>> readCreatePost({required String collection, required String uid}) =>
        FirebaseFirestore.instance
        .collection(collection)
  ...
  // 스크랩한 글 보기
  static Stream<List<PostListModel>> readScrapPost({required String collection, required String uid}) =>
        FirebaseFirestore.instance
        .collection(collection)
