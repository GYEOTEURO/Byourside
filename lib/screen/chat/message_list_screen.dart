...
// import 'package:byourside/widget/chat_message.dart';
...
//                           return ChatMessage(
//                             text: messages[index].content.toString(),
//                             name: messages[index].user.toString(),
//                             me: _auth.currentUser?.displayName.toString() == messages[index].user,
//                             date: messages[index].sendDate.toString(),
//                           );
//                           // ListTile(
...
//                   ),
//                 ),
//                 onSubmitted: _onPressedSendButton,
//               ),
//             ),
//             SizedBox(
//               width: 10,
...
//             RawMaterialButton(
//               onPressed: () {
//                 _onPressedSendButton(controller.text);
//               },
//               //전송버튼을 누를때 동작시킬 메소드
...
//   }
//
//   void _onPressedSendButton(String text) {
//     try {
//       //서버로 보낼 데이터를 모델클래스에 담아둔다.
//       //여기서 sendDate에 Timestamp.now()가 들어가는데 이는 디바이스의 시간을 나타내므로 나중에는 서버의 시간을 넣는 방법으로 변경하도록 하자.
//       MessageModel messageModel =
//           MessageModel(content: controller.text, user: _auth.currentUser!.displayName.toString(), sendDate: Timestamp.now());
//
//       //Firestore 인스턴스 가져오기
//       FirebaseFirestore firestore = FirebaseFirestore.instance;
//       //원하는 collection 주소에 새로운 document를 Map의 형태로 추가하는 모습.
//       firestore
//           .collection('chatrooms/rmTSYR79UlMiJo2wGVV8/messages')
