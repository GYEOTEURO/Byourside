...
class _CommunityPostContentState extends State<CommunityPostContent> {
  ...
  Widget _buildLikesAndScraps(String likesOrScraps, icon, String likesOrScrapsCount){
    return Row(
            children: [
              Text(
                likesOrScraps,
    ...
    return Column(children: [
      ...
      Row(
        ...
        children: [
          Row(
            children: [
              _buildLikesAndScraps('좋아요', custom_icons.communityPostListLikes, widget.post.likes.toString()),
              const SizedBox(width: 20),
              _buildLikesAndScraps('스크랩', custom_icons.communityPostListScraps, widget.post.scraps.toString())
          ]),
