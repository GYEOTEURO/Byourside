...
const String onboardingBeeside = 'Beeside(비사이드)는 발달장애와 뇌병변장애 아동 보호자를 위한 맞춤형 정보 제공 및 커뮤니티 서비스입니다.';
const String onboardingAutoInformation = '정보게시판에서 비사이드가 모아둔 다양한 장애 관련 정보를 볼 수 있습니다.';
const String onboardingCommunity = '소통게시판에서 장애 관련 이야기를 나누면서 정보를 공유해보세요.';