...
List<Map<String, dynamic>> setting = [
  ...
  {
    'name' : '개인정보처리방침',
    'page' : Policy(policy: personalData)
  },
  {
    'name' : '서비스 이용약관',
    'page' : Policy(policy: usingPolicy)
  },
  {
    'name' : '탈퇴하기',
    'page' : MyCommunityPost()
